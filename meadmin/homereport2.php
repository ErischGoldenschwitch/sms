						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-list"></i> <span>Best Performer</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-list"></i> <span>Student Term1</span></a></li>
											
											<li><a href="#section-3" class="icon-shop"><i class="lnr lnr-list"></i> <span>Student Term2</span></a></li>
											
											<li><a href="#section-4" class="icon-shop"><i class="lnr lnr-list"></i> <span>Student Term3</span></a></li>
