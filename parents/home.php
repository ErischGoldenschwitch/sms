									...
									<div class="content tab">
										<section id="section-1">
											...
											<div class="mediabox">
												...
												<p><strong>Father Contact: </strong>
													<?php echo ucfirst($parent_name_display['fatherphone']); ?>
                                                    
                                                    <p><strong>Mother Contact: </strong>
													<?php echo ucfirst($parent_name_display['motherphone']); ?>
												</p>
											</div>
										</section>
